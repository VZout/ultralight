...
extern "C" {
    pub fn __security_check_cookie(_StackCookie: ::std::os::raw::c_ulonglong);
}
extern "C" {
    pub fn __report_gsfailure(_StackCookie: ::std::os::raw::c_ulonglong) -> !;
}
extern "C" {
    pub static mut __security_cookie: ::std::os::raw::c_ulonglong;
}
