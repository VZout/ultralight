...
[[vk::binding(2)]] Texture2D texture1 : register(t1);
[[vk::binding(3)]] SamplerState sampler0 : register(s0);
...
float4 blend(float4 src, float4 dest) {
  return float4(src.rgb + dest.rgb * (1.0 - src.a), src.a + dest.a * (1.0 - src.a));
}
